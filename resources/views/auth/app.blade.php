                ...
                <div class="d-flex flex-column flex-center p-10 w-100 h-100">
                    ...
                    <a href="{{ route('home') }}">
                        <img class="theme-light-show mx-auto mw-100 w-125px w-lg-300px mb-6 mb-lg-20"
                            src="{{ asset('assets/img/icon.png') }}" alt="Shunno Art Cafe Logo" />

                        <img class="theme-dark-show mx-auto mw-100 w-125px w-lg-300px mb-6 mb-lg-20"
                            src="{{ asset('assets/img/icon.png') }}" alt="Shunno Art Cafe Logo" />
                    </a>

                    <h1 class="text-gray-800 fs-2qx fw-bold text-center mb-0 mb-lg-13">
                        Shunno Art Cafe
                    </h1>

                    <div class="text-gray-600 fs-base text-center fw-semibold d-none d-lg-block">
                        A thoughtful and curated reservation experience for art, learning, creativity,<br>
                        dialogue, and community at Shunno Art Cafe. 
                        Every reservation request is reviewed before<br> confirmation to ensure a meaningful
