...
@if ($locked)
    ...
    <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-4 mb-5">
        ...
        <div class="fs-7 text-gray-700">
            ...
            time and party size are locked — the visitor has been quoted a figure and changing it here
            would silently re-price what they were asked to pay. Notes can still be edited.
        </div>
    </div>
@else
